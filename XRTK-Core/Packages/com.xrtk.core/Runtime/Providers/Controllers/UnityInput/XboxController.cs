...
namespace XRTK.Providers.Controllers.UnityInput
{
    ...
    public class XboxController : GenericJoystickController
    {
        ...
        /// <inheritdoc />
        public XboxController(IMixedRealityControllerDataProvider controllerDataProvider, TrackingState trackingState, Handedness controllerHandedness, MixedRealityControllerProfile controllerProfile)
