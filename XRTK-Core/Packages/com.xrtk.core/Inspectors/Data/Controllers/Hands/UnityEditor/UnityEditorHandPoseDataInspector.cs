...
namespace XRTK.Inspectors.Data.Controllers.Hands.UnityEditor
{
    [CustomEditor(typeof(UnityEditorHandPoseData))]
    public class UnityEditorHandPoseDataInspector : BaseMixedRealityProfileInspector
    {
