...
namespace XRTK.Providers.Controllers.OpenVR
{
    ...
    {
        /// <inheritdoc />
        public OculusTouchOpenVRController(IMixedRealityControllerDataProvider dataProvider, TrackingState trackingState, Handedness controllerHandedness, IMixedRealityInputSource inputSource = null, MixedRealityInteractionMapping[] interactions = null)
        ...
        public override MixedRealityInteractionMapping[] DefaultLeftHandedInteractions => new[]
        {
            ...
            new MixedRealityInteractionMapping(5, "Axis1D.PrimaryHandTrigger Press", AxisType.Digital, DeviceInputType.TriggerPress, ControllerMappingLibrary.AXIS_11),
        ...
        public override MixedRealityInteractionMapping[] DefaultRightHandedInteractions => new[]
        {
            ...
            new MixedRealityInteractionMapping(5, "Axis1D.SecondaryHandTrigger Press", AxisType.Digital, DeviceInputType.TriggerPress, ControllerMappingLibrary.AXIS_12),
