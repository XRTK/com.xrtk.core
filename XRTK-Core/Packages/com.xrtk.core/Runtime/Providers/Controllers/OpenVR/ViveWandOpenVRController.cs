...
namespace XRTK.Providers.Controllers.OpenVR
{
    ...
    public class ViveWandOpenVRController : GenericOpenVRController
    {
        ...
        /// <inheritdoc />
        public ViveWandOpenVRController(IMixedRealityControllerDataProvider controllerDataProvider, TrackingState trackingState, Handedness controllerHandedness, MixedRealityControllerProfile controllerProfile)
