...
//    /// </summary>
//    public class BuildDeployWindowOld : EditorWindow
//    {
...
//        [MenuItem("Mixed Reality Toolkit/Build Window (old)", false, 99)]
//        public static void OpenWindow()
//        {
//            // Dock it next to the Scene View.
//            var window = GetWindow<BuildDeployWindowOld>(typeof(SceneView));
//            window.titleContent = new GUIContent("Build Window (old)");
//            window.Show();
//        }

//        private void OnEnable()
//        {
//            titleContent = new GUIContent("Build Window (old)");
