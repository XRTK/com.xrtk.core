...
//            try
//            {
//                detectedController = Activator.CreateInstance(controllerType, this, TrackingState.NotTracked, handedness, GetControllerProfile(controllerType, handedness)) as GenericOpenVRController;
//            }
//            catch (Exception e)
//            {
//                Debug.LogError(e);
