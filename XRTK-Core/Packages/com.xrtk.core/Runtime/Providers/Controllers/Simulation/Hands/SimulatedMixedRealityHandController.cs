...
namespace XRTK.Providers.Controllers.Simulation.Hands
{
    ...
    public class SimulatedMixedRealityHandController : MixedRealityHandController, IMixedRealitySimulatedController
    {
        ...
        /// <inheritdoc />
        public SimulatedMixedRealityHandController(IMixedRealityControllerDataProvider controllerDataProvider, TrackingState trackingState, Handedness controllerHandedness, MixedRealityControllerProfile controllerProfile)
