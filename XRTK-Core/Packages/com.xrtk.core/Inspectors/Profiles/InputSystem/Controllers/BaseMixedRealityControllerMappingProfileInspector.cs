    ...
    public class BaseMixedRealityControllerMappingProfileInspector : BaseMixedRealityProfileInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            for (int i = 0; i < controllerMappings?.arraySize; i++)
            {
                ...
                {
                    serializedObject.ApplyModifiedProperties();
                    EditorApplication.delayCall += () => ControllerPopupWindow.Show(controllerMappingProfile, controllerMappingProfile.ControllerType, interactions, handedness, MixedRealityPreferences.LockProfiles && !ThisProfile.IsDefaultProfile);
                }
