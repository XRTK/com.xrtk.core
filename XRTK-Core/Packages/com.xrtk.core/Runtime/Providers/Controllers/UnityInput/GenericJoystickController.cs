...
namespace XRTK.Providers.Controllers.UnityInput
{
    ...
    public class GenericJoystickController : BaseController
    {
        ...
        /// <inheritdoc />
        public GenericJoystickController(IMixedRealityControllerDataProvider controllerDataProvider, TrackingState trackingState, Handedness controllerHandedness, MixedRealityControllerProfile controllerProfile)
