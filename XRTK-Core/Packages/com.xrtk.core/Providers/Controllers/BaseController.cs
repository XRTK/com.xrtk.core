        ...
        internal async Task TryRenderControllerModelAsync(Type controllerType, byte[] glbData = null, bool useAlternatePoseAction = false)
        {
            ...
            if (controllerModel != null)
            {
                ...
                if (useSystemDefaultModels && gltfObject != null)
                {
                    ...
                    controllerModel.transform.SetParent(MixedRealityToolkit.CameraSystem.CameraRig.HeadTransform);
                ...
                {
                    var controllerObject = UnityEngine.Object.Instantiate(controllerModel, MixedRealityToolkit.CameraSystem.CameraRig.HeadTransform);
